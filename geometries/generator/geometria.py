...
radio_principal = $rdd  # Radio del cilindro en m
altura_principal = $l11  # Altura del cilindro en m
...
radio_pequeno = $rpp  # Radio de los cilindros pequeños en mm
altura_pequeno = $aa  # Altura de los cilindros pequeños en mm
