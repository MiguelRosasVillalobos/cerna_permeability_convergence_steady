...
v1foam = OpenFOAMReader(
    ...
    FileName="/home/miguel/cerna_permeability_convergence_steady/Case_$ii/Case_$ii_$jj/$jj.foam",
)
...
# save data
SaveData(
    "/home/miguel/cerna_permeability_convergence_steady/Case_$ii/$jj_vel.csv",
    proxy=passArrays1,
    PointDataArrays=[
        "U",
        "arc_length",
